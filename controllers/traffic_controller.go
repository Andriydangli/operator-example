...
//+kubebuilder:rbac:groups=test.io.apiserver,resources=traffics/status,verbs=get;update;patch
...
func (r *TrafficReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	err := r.Client.Get(ctx, req.NamespacedName, traffic)
	if err != nil {
		log.Log.Error(err, "get traffic resource failed")
		return ctrl.Result{}, err
	}
	log.Log.Info("traffic date: ", traffic.Spec.Date)
	log.Log.Info("traffic resource: ", traffic.Name, traffic.Namespace)
